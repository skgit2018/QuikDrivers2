...
<!-- Mirrored from htmlstream.com/preview/unify-v1.9.6/page_profile_projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Oct 2016 11:35:17 GMT -->
...
<body>
    <div class="wrapper">
        @include('inc.menu')        <section id="projects">
            <!--=== Profile ===-->
                                ...
                                <section id="Pay">
                                    ...
                                    <div class="panel panel-profile">
                                        <div class="panel-heading overflow-h">
                                            ...
                                            <h2 class="panel-title heading-sm pull-left">Bank Account Details</h2>
                                           
                                <a href="#" class="btn btn-info btn-lgs">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="field">Accuont Holder Name</td>
                                                        <td>Arjun</td>
                                                    </tr>
                                                    <tr>
                        ...
                        <div class="profile-body">
                            ...
                            <div class="row">
                                <section id="Pay">
                                    ...
                                    <div class="panel panel-profile">
                                        <div class="panel-heading overflow-h">
                                            <h2 class="panel-title heading-sm pull-left">MyBooking Payments</h2>
                                            <a href="#"></a>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table table-hover table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr class="highlight">
                                                        <td class="field">Pending</td>
                                                        <td>1000</td>
                                                    </tr>

                                                    <tr>
                                                        <td class="field">Credit</td>
                                                        <td> 30000</td>
                                                    </tr>
