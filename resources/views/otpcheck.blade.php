                        ...
                        <div class="wrapperone fadeInDown">
                            <div id="formContent">
                                ...
                                <div class="fadeIn first">
                                    ...
                                    <p>Verified and log in</p>
                                    <small> Enter the Otp  sent to your mobile 78932910</small>
                                </div>

                                <!-- Login Form -->
                                <form id=number-form>
                                    <input type="text" id=number class="form-control" name=number  placeholder="Enter OTP ">



                                </form>
                                <span class="otp">
                                    <button type="btn-btn" value="submit"><a href="/driververification">Sign in</a></button></span>
                                <a  href="#">Resend otp</a>
                                <!-- Remind Passowrd -->
                            </div>
                        </div>
