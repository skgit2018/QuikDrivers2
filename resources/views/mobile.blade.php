...
<html lang="en">
    ...
    <body>
        ...
        <section id="mobile-number">

            <div class="row">
                <div class="col-md-12">
                    <div class="container">
                        <div class="wrapperone fadeInDown">
                            <div id="formContent">
                                ...
                                <div class="fadeIn first">
                                    ...
                                    <small> A 4-digit OTP will be sent on SMS</small>
                                </div>
                                <!-- Login Form -->
                                
                                 <!--{!! Form::open(['url' => '/mobile/no', 'method' =>'POST', 'enctype' => 'multipart/form-data' ]) !!}-->
                                <form id=number-form action="mobile/no" method="post">
                                    {{ csrf_field() }}
                                    <input type="text" id=number class="form-control" name="mobile_no"  placeholder="Enter Mobile Number">
                               
                                <span class="otp">
                                    <!--<button class="btn-btn" type="submit"><a href=>Request Otp</a></button></span>-->
                                    <input class="btn-btn" type="submit" value="Request Otp" />
                                <!-- {!! Form::close() !!}-->
                                 </form>
                                <br/>
                                <!-- Remind Passowrd -->
